...
public class CameraRecoil : MonoBehaviour
{
    ...
    // Private variables - these store the recoil OFFSET, not absolute rotation
    ...
    /// <summary>
    /// Get the current recoil offset to be added to camera rotation
    /// </summary>
    ...
    public void FireRecoil(float intensity)
    {
        ...
        // Apply recoil (negative X for upward kick)
